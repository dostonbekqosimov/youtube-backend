...
public class EmailTemplateService {
    ...
    public String getRegistrationEmailTemplate(String email, String userName, int deadlineHours, int remainingAttempts, Integer verificationCode) {
        ...
        String content = """
                    <div class="content">
                        ...
                        <p>If the link has expired, <a href="%s/api/auth/registration/resend?email=%s"\s
    ...
    public String getResendConfirmationEmailTemplate(String email, String userName, int deadlineHours, int remainingAttempts, Integer verificationCode) {
